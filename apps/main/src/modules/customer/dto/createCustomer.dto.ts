...
export class CreateCustomerDto {
  ...
  @IsInt({
    message: 'documentType: El documentType del cliente debe ser un número',
  })
  ...
  @IsDateString(
    {},
    { each: true, message: 'birthDate: La fecha no es correcta' },
  )
  birthDate?: Date;
  ...
  @IsString({
    message: 'phoneNumber: El phoneNumber del cliente debe ser texto',
  })
  phoneNumber: string;
